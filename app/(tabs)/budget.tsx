...
export default function BudgetScreen() {
  ...
  const loadBudgetData = useCallback(async () => {
    ...
    try {
      ...
      const summary = budgetService.getMonthlyBudgetSummary(
        year,
        month,
        profileId,
      );
      ...
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: () => {
            const budgetService = getBudgetService();
            const allBudgets = budgetService.getBudgets();
            const fullBudget = allBudgets.find(
              ...
              <View style={styles.budgetBar}>
                ...
                <View style={styles.progressContainer}>
                    ...
                    <View
                      style={[
                        styles.progressFill,
                        {
                          ...
                          backgroundColor:
                            budgetData.spent > budgetData.expenseLimit
                              ? "#ef4444"
                              : "#14b8a6",
                        },
                      ]}
                  ...
                  <Text style={styles.progressLimit}>
                    Limit: {formatCurrency(budgetData.expenseLimit)}
                  </Text>
                </View>
              </View>
